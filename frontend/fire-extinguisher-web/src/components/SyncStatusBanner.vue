<template>
  <div v-if="shouldShow" class="fixed top-0 left-0 right-0 z-50 animate-slide-down">
    <!-- Offline Banner -->
    <div
      v-if="!status.online"
    ...
    >
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center">
          ...
          <div>
            <p class="text-sm font-medium">Working Offline</p>
            <p v-if="hasPending" class="text-xs text-gray-300 mt-0.5">
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center">
          ...
          <div>
            ...
            <p v-if="hasPending" class="text-xs text-blue-100 mt-0.5">
    ...
    >
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center">
          ...
          <p class="text-sm font-medium">All items synced successfully</p>
        </div>
      </div>
    </div>
  </div>
