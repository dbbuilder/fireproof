<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div
      v-if="inspection"
      class="max-w-2xl mx-auto px-4 py-6 sm:px-6 lg:px-8 space-y-6"
    >
      <!-- Success Alert (if just completed) -->
      <div
        v-if="route.query.completed === 'true'"
        class="bg-green-50 border border-green-200 rounded-lg p-4 animate-slide-down"
      >
        <div class="flex">
          <svg
      ...
      <div class="bg-white rounded-lg shadow-soft p-6">
        <div class="flex items-center justify-between mb-4">
          ...
          >
            <svg
              v-if="inspection.overallResult === 'Pass'"
              class="h-8 w-8"
              fill="currentColor"
              viewBox="0 0 20 20"
            >
            ...
            <svg
              v-else-if="inspection.overallResult === 'Fail'"
              class="h-8 w-8"
              fill="currentColor"
              viewBox="0 0 20 20"
            >
        ...
        <!-- GPS Info -->
        <div
          v-if="inspection.latitude && inspection.longitude"
        ...
        <!-- Verification Status -->
        <div
          v-if="inspection.inspectionHash"
          class="mt-4 pt-4 border-t border-gray-200"
        >
      ...
      <!-- Checklist Responses -->
      <div
        v-if="inspection.checklistResponses && inspection.checklistResponses.length > 0"
      ...
      <!-- Deficiencies -->
      <div
        v-if="inspection.deficiencies && inspection.deficiencies.length > 0"
        class="bg-white rounded-lg shadow-soft p-6"
      >
        <h3 class="text-lg font-semibold text-gray-900 mb-4">
      ...
      <!-- Inspector Signature -->
      <div
        v-if="inspection.inspectorSignature"
        class="bg-white rounded-lg shadow-soft p-6"
      >
        <h3 class="text-lg font-semibold text-gray-900 mb-4">
          Inspector Signature
    ...
    >
      <div
        class="bg-white rounded-t-lg sm:rounded-lg p-4 w-full max-w-sm space-y-2 animate-slide-up"
        @click.stop
      >
        <button
