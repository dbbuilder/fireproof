<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-white border-b border-gray-200 sticky top-0 z-10">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          ...
          <h1 class="text-lg font-semibold text-gray-900">Complete Inspection</h1>
          <div class="w-20"></div>
        </div>
      </div>
    </div>
    ...
    <!-- Main Content -->
    <div v-if="inspection" class="max-w-2xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div class="bg-white rounded-lg shadow-soft p-6 mb-6">
        <div class="flex items-center mb-4">
          ...
          <div class="ml-4">
            <h2 class="text-xl font-semibold text-gray-900">Inspection Summary</h2>
            <p class="text-sm text-gray-600">Review and finalize your inspection</p>
          </div>
        </div>
      ...
      <div class="bg-white rounded-lg shadow-soft p-6 mb-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Overall Result *</h3>
        <p class="text-sm text-gray-600 mb-4">Select the final inspection result</p>
        ...
        <div class="grid grid-cols-1 gap-3">
          ...
          >
            ...
            >
              <svg v-if="overallResult === 'Pass'" class="h-4 w-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
              </svg>
            </div>
            <div class="flex-1 text-left">
              <p :class="overallResult === 'Pass' ? 'text-green-900' : 'text-gray-900'" class="font-medium">Pass</p>
              <p :class="overallResult === 'Pass' ? 'text-green-700' : 'text-gray-600'" class="text-sm">All items meet requirements</p>
            </div>
          </button>
          ...
          >
            <div
              ...
              class="flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center mr-3"
            >
              <svg v-if="overallResult === 'ConditionalPass'" class="h-4 w-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
              </svg>
            </div>
            <div class="flex-1 text-left">
              <p :class="overallResult === 'ConditionalPass' ? 'text-yellow-900' : 'text-gray-900'" class="font-medium">Conditional Pass</p>
              <p :class="overallResult === 'ConditionalPass' ? 'text-yellow-700' : 'text-gray-600'" class="text-sm">Minor issues require attention</p>
            </div>
          </button>
          ...
          >
            <div
              ...
              class="flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center mr-3"
            >
              <svg v-if="overallResult === 'Fail'" class="h-4 w-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
              </svg>
            </div>
            <div class="flex-1 text-left">
              <p :class="overallResult === 'Fail' ? 'text-red-900' : 'text-gray-900'" class="font-medium">Fail</p>
              <p :class="overallResult === 'Fail' ? 'text-red-700' : 'text-gray-600'" class="text-sm">Critical issues found, immediate action required</p>
            </div>
          </button>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow-soft p-6 mb-6">
        ...
        <p class="text-sm text-gray-600 mb-4">Add any additional comments or observations</p>
      ...
      <div class="bg-white rounded-lg shadow-soft p-6 mb-6">
        ...
        <p class="text-sm text-gray-600 mb-4">Confirm your identity to finalize this inspection</p>

        <div class="space-y-4">
          <div>
            <label for="signature-name" class="block text-sm font-medium text-gray-700 mb-1">
              Full Name
            </label>
            <input
              id="signature-name"
          ...
          <div class="flex items-start">
            ...
            />
            <label for="confirm-accuracy" class="ml-2 text-sm text-gray-700">
